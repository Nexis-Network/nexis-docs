...
title: Home
sidebar_label: Home
pagination_label: Nexis Network Validator Documentation Home
...
# Nexis Network Validator Documentation

Nexis Network is a blockchain built for mass adoption. It's a high performance network
that is utilized for a range of use cases, including finance, NFTs, payments,
and gaming. Nexis Network operates as a single global state machine, and is open,
...
- [Install the Nexis Network CLI Tool Suite](./cli/install.md) - Quickly get setup
...
- [Choose a cluster](./cli/examples/choose-a-cluster.md) - Select a Nexis Network
...
Explore what it takes to operate a Nexis Network validator and help secure the network.
