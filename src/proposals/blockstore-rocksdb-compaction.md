---
title: Optimize RocksDB Compaction for Nexis Network BlockStore
---

This document explores RocksDB based solutions for Nexis Network BlockStore
mentioned in issue [#16234](https://github.com/nexis-labs/nexis/issues/16234).

## Background
Nexis Network uses RocksDB as the underlying storage for its blockstore.  RocksDB
...
optimization for Nexis Network's Blockstore.

## Problems
As mentioned in [#16234](https://github.com/nexis-labs/nexis/issues/16234),
there're several issues in the Nexis Network's BlockStore which runs RocksDB with
...
In [#14586](https://github.com/nexis-labs/nexis/issues/14586), it is reported
that the write stalls in Nexis Network's use case can be 40 minutes long.  It is also
reported in [#16234](https://github.com/nexis-labs/nexis/issues/16234) that
...
in Nexis Network's BlockStore use case:
...
issues of blockstore [#16234](https://github.com/nexis-labs/nexis/issues/16234).
It minimizes read / write / space amplification factors by leveraging the
unique property of Nexis Network BlockStore workload where write-keys are mostly
