...
[inflation](https://nexis.network/docs/terminology#inflation). The number of
...
[point](https://nexis.network/docs/terminology#point).
...
[sysvar](https://nexis.network/docs/terminology#sysvar) that maps epochs to point
values.
