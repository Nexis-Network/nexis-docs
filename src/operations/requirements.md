...
There is no strict minimum amount of SOL required to run a validator on Nexis Network.
...
releases at [solanalabs/nexis](https://hub.docker.com/r/solanalabs/nexis).
