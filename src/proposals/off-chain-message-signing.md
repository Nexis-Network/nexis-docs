...
a Nexis Network wallet. Typically this is some kind of "proof of wallet ownership" for
...
The remaining bytes, `b"nexis offchain"`, were chosen to be descriptive and
...
Nexis Network off-chain messages **MUST** only be signed using the ed25519 digital
...
[zero is supported](https://github.com/nexis-labs/nexis/blob/b6ae6c1fe17e4b64c5051c651ca2585e4f55468c/sdk/program/src/message/versions/mod.rs#L269-L281)
...
The runtime changes described above have been implemented in PR [#29807](https://github.com/nexis-labs/nexis/pull/29807)
