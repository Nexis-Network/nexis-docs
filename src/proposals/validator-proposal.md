...
When we first started Nexis Network, the goal was to de-risk our TPS claims. We knew
...
- TPU moves to new socket-free crate called nexis-tpu.
...
- JSON RPC Service is optional - used for debugging. It should instead be part
  of a separate `nexis-blockstreamer` executable.
