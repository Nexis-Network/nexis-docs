...
```
{
	"libpath": "/nexis/target/release/libsolana_geyser_plugin_postgres.so",
...
The sample [postgresql.conf](https://github.com/nexis-labs/nexis/blob/7ac43b16d2c766df61ae0a06d7aaf14ba61996ac/accountsdb-plugin-postgres/scripts/postgresql.conf)
...
Use the [create_schema.sql](https://github.com/nexis-labs/nexis/blob/a70eb098f4ae9cd359c1e40bbb7752b3dd61de8d/accountsdb-plugin-postgres/scripts/create_schema.sql)
to create the objects for storing accounts and slots.

Download the script from github:

```
wget https://raw.githubusercontent.com/nexis-labs/nexis/a70eb098f4ae9cd359c1e40bbb7752b3dd61de8d/accountsdb-plugin-postgres/scripts/create_schema.sql
```
...
[drop_schema.sql](https://github.com/nexis-labs/nexis/blob/a70eb098f4ae9cd359c1e40bbb7752b3dd61de8d/accountsdb-plugin-postgres/scripts/drop_schema.sql).
For example,
