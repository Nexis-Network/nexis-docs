...
cat > "$CONFIG_FILE" <<EOF
{
  ...
  "redirects": [
    ...
    { "source": "/running-validator", "destination": "/architecture" },
    { "source": "/validator/get-started/setup-a-validator", "destination": "/architecture/setup-a-validator" },
    { "source": "/validator/get-started/setup-an-rpc-node", "destination": "/architecture/setup-an-rpc-node" },
    { "source": "/validator/best-practices/architecture", "destination": "/architecture/best-practices/general" },
    { "source": "/validator/best-practices/monitoring", "destination": "/architecture/best-practices/monitoring" },
    { "source": "/validator/best-practices/security", "destination": "/architecture/best-practices/security" },
    { "source": "/validator/overview/running-validator-or-rpc-node", "destination": "/architecture/validator-or-rpc-node" },
    { "source": "/validator/overview/validator-prerequisites", "destination": "/architecture/prerequisites" },
    { "source": "/validator/overview/validator-initiatives", "destination": "/architecture/validator-initiatives" },
    { "source": "/running-validator/validator-reqs", "destination": "/architecture/requirements" },
    { "source": "/running-validator/validator-troubleshoot", "destination": "/architecture/guides/validator-troubleshoot" },
    { "source": "/running-validator/validator-start", "destination": "/architecture/guides/validator-start" },
    { "source": "/running-validator/vote-accounts", "destination": "/architecture/guides/vote-accounts" },
    { "source": "/running-validator/validator-stake", "destination": "/architecture/guides/validator-stake" },
    { "source": "/running-validator/validator-monitor", "destination": "/architecture/guides/validator-monitor" },
    { "source": "/running-validator/validator-info", "destination": "/architecture/guides/validator-info" },
    { "source": "/running-validator/validator-failover", "destination": "/architecture/guides/validator-failover" },
    { "source": "/running-validator/restart-cluster", "destination": "/architecture/guides/restart-cluster" },
