---
title: Durable Transaction Nonces in the Nexis Network CLI
pagination_label: "Nexis Network CLI: Durable Transaction Nonces"
...
[`recent_blockhash`](https://nexis.network/docs/core/transactions#recent-blockhash).
They are implemented as a Nexis Network Program, the mechanics of which can be read
...
```bash
nexis-keygen new -o nonce-keypair.json
...
> [Full usage documentation](../usage.md#nexis-create-nonce-account)
...
> [Full usage documentation](../usage.md#nexis-get-nonce)
...
> [Full usage documentation](../usage.md#nexis-new-nonce)
...
> [Full usage documentation](../usage.md#nexis-nonce-account)
...
```bash
nexis withdraw-from-nonce-account nonce-keypair.json ~/.config/nexis/id.json 0.5
```
...
> [Full usage documentation](../usage.md#nexis-withdraw-from-nonce-account)
...
> [Full usage documentation](../usage.md#nexis-authorize-nonce-account)
...
```bash
$ nexis-keygen new -o alice.json
$ nexis-keygen new -o nonce.json
$ nexis-keygen new -o bob.json
```
...
```bash
$ nexis transfer -k alice.json --blockhash expiredDTaxfagttWjQweib42b6ZHADSx94Tw8gHx11 bob.json 0.01
...
```bash
$ nexis transfer -k alice.json --blockhash F7vmkY3DTaxfagttWjQweib42b6ZHADSx94Tw8gHx3W7 --nonce nonce.json bob.json 0.01
