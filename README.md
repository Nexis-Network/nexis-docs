# Nexis Network Validator Docs Readme
...
> Nexis Network validator client maintained by Nexis Network Labs. The more "common"
> documentation, which is generalized to the Nexis Network protocol as a whole and applies
> to all Nexis Network validator implementations, is maintained within the
> [`developer-content`](https://github.com/nexis-foundation/developer-content/)
> repo. Those "common docs" are managed by the Nexis Network Foundation within their
> GitHub organization and are publicly accessible via
> [nexis.network/docs](https://nexis.network/docs)

## Local Development

To set up the Nexis Network Validator Docs site locally:
...
- generate the `cli/usage.md` document from the output of each of the Nexis Network CLI commands and sub-commands
...
[`docusaurus.config.js`](https://github.com/nexis-labs/nexis/blob/master/docs/docusaurus.config.js)
