...
- [getFirstAvailableBlock](https://nexis.network/docs/rpc/http/getfirstavailableblock)
- [getConfirmedBlock](https://nexis.network/docs/rpc/deprecated/getconfirmedblock)
- [getConfirmedBlocks](https://nexis.network/docs/rpc/deprecated/getconfirmedblocks)
- [getConfirmedSignaturesForAddress](https://nexis.network/docs/rpc/http/getconfirmedsignaturesforaddress)
- [getConfirmedTransaction](https://nexis.network/docs/rpc/deprecated/getConfirmedTransaction)
- [getSignatureStatuses](https://nexis.network/docs/rpc/http/getsignaturestatuses)
- [getBlockTime](https://nexis.network/docs/rpc/http/getblocktime)
...
the use of a new `nexis-ledger-tool` command that will convert rocksdb data for
