...
*Paraphrasing from https://github.com/nexis-labs/nexis/issues/26847*
...
3. The `start offset` should be *after* the `rewarding interval`
   (from [Partitioned Inflationary Rewards Distribution](https://github.com/nexis-labs/nexis/pull/27455)).
