---
title: Nexis Network Validator Requirements
sidebar_position: 3
sidebar_label: Requirements
pagination_label: Requirements to Operate a Validator
---

## Minimum NZT requirements

There is no strict minimum amount of NZT required to run a validator on Nexis Network.

However in order to participate in consensus, a vote account is required which
has a rent-exempt reserve of 0.02685864 NZT. Voting also requires sending a vote
...
releases at [nexislabs/nexis](https://hub.docker.com/r/nexislabs/nexis).

## Software

- We build and run on Ubuntu 20.04.
- See [Installing Nexis Network CLI](../cli/install.md) for the current Nexis Network software release.
