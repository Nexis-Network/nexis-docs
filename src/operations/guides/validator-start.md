...
```bash
nexis config set --url http://api.devnet.nexis.network
```
...
RPC URL: http://api.devnet.nexis.network
...
Read more about the [difference between SOL and lamports here](https://nexis.network/docs/intro#what-are-sols).
...
here](https://github.com/nexis-labs/nexis/blob/aa72aa87790277619d12c27f1ebc864d23739557/core/src/ledger_cleanup_service.rs#L26-L37).
...
The validator log file, as specified by `--log ~/nexis-validator.log`, can get
