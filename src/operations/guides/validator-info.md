...
## Run nexis validator-info

Run the nexis CLI to populate a validator info account:
...
```bash
nexis validator-info publish "Elvis Validator" -w "https://elvis-validates.com" -i "https://elvis-validates.com/my-icon.png"
```
