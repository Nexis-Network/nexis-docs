---
title: Nexis Network ABI management process
---

This document proposes the Nexis Network ABI management process. The ABI management
...
The Nexis Network ABI (binary interface to the cluster) is currently only defined
