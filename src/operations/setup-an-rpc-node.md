...
If you are interested in setting up your own bigtable instance, see these docs in the Nexis Network GitHub repository: [nexis-labs/nexis-bigtable](https://github.com/nexis-labs/nexis-bigtable)
