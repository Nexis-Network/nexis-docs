---
title: Using Hardware Wallets in the Nexis Network CLI
pagination_label: "Using Hardware Wallets in the Nexis Network CLI"
sidebar_label: Using in the Nexis Network CLI
sidebar_position: 0
---
...
The Nexis Network CLI has first class support for hardware wallets. Anywhere
...
The Nexis Network CLI supports the following hardware wallets:

- [Ledger Nano S and Ledger Nano X](./ledger.md)

## Specify a Keypair URL

Nexis Network defines a keypair URL format to uniquely locate any Nexis Network keypair on a
...
`DERVIATION_PATH` is used to navigate to Nexis Network keys within your hardware wallet.
...
and that any derived keys are Nexis Network keys (Coin type 501). The single quote
indicates a "hardened" derivation. Because Nexis Network uses Ed25519 keypairs, all
