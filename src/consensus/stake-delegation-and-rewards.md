...
[inflation](https://nexis.com/docs/terminology#inflation). The number of
...
[point](https://nexis.com/docs/terminology#point).
...
[sysvar](https://nexis.com/docs/terminology#sysvar) that maps epochs to point
values.
