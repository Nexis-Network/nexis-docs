...
[delegate tokens in a stake account](https://nexis.network/docs/economics/staking),
...
the validator operator may choose to store only enough NZT on the identity
...
a vote account withdraws all remaining NZT funds to a supplied recipient address
