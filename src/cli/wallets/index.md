---
title: Nexis Network Wallets with the CLI
pagination_label: Command Line Wallets
sidebar_label: Overview
sidebar_position: 0
---

Nexis Network supports several different types of wallets that can be used to interface
directly with the Nexis Network command-line tools.

To use a Command Line Wallet, you must first [install the Nexis Network CLI tools](../install.md)
