---
title: Develop on Native NEXIS
---




# Developing on native Nexis 
...
To interact with a Nexis Network node inside a JavaScript application, use the [nexis-web3.js](https://github.com/nexis-labs/nexis-web3.js) library, which gives a convenient interface for the RPC methods.
...
- [getAccountInfo](https://docs.nexis.network/apps/jsonrpc-api#getaccountinfo)
- [getBalance](https://docs.nexis.network/apps/jsonrpc-api#getbalance)
- [getBlockCommitment](https://docs.nexis.network/apps/jsonrpc-api#getblockcommitment)
- [getBlockTime](https://docs.nexis.network/apps/jsonrpc-api#getblocktime)
- [getClusterNodes](https://docs.nexis.network/apps/jsonrpc-api#getclusternodes)
- [getConfirmedBlock](https://docs.nexis.network/apps/jsonrpc-api#getconfirmedblock)
- [getConfirmedBlocks](https://docs.nexis.network/apps/jsonrpc-api#getconfirmedblocks)
- [getConfirmedBlocksWithLimit](https://docs.nexis.network/apps/jsonrpc-api#getconfirmedblockswithlimit)
- [getConfirmedSignaturesForAddress](https://docs.nexis.network/apps/jsonrpc-api#getconfirmedsignaturesforaddress)
- [getConfirmedSignaturesForAddress2](https://docs.nexis.network/apps/jsonrpc-api#getconfirmedsignaturesforaddress2)
- [getConfirmedTransaction](https://docs.nexis.network/apps/jsonrpc-api#getconfirmedtransaction)
- [getEpochInfo](https://docs.nexis.network/apps/jsonrpc-api#getepochinfo)
- [getEpochSchedule](https://docs.nexis.network/apps/jsonrpc-api#getepochschedule)
- [getFeeCalculatorForBlockhash](https://docs.nexis.network/apps/jsonrpc-api#getfeecalculatorforblockhash)
- [getFeeRateGovernor](https://docs.nexis.network/apps/jsonrpc-api#getfeerategovernor)
- [getFees](https://docs.nexis.network/apps/jsonrpc-api#getfees)
- [getFirstAvailableBlock](https://docs.nexis.network/apps/jsonrpc-api#getfirstavailableblock)
- [getGenesisHash](https://docs.nexis.network/apps/jsonrpc-api#getgenesishash)
- [getHealth](https://docs.nexis.network/apps/jsonrpc-api#gethealth)
- [getIdentity](https://docs.nexis.network/apps/jsonrpc-api#getidentity)
- [getInflationGovernor](https://docs.nexis.network/apps/jsonrpc-api#getinflationgovernor)
- [getInflationRate](https://docs.nexis.network/apps/jsonrpc-api#getinflationrate)
- [getInflationReward](https://docs.nexis.network/apps/jsonrpc-api#getinflationReward)
- [getLargestAccounts](https://docs.nexis.network/apps/jsonrpc-api#getlargestaccounts)
- [getLeaderSchedule](https://docs.nexis.network/apps/jsonrpc-api#getleaderschedule)
- [getMaxRetransmitSlot](https://docs.nexis.network/apps/jsonrpc-api#getmaxretransmitSlot)
- [getMaxShredInsertSlot](https://docs.nexis.network/apps/jsonrpc-api#getmaxshredinsertSlot)
- [getMinimumBalanceForRentExemption](https://docs.nexis.network/apps/jsonrpc-api#getminimumbalanceforrentexemption)
- [getMultipleAccounts](https://docs.nexis.network/apps/jsonrpc-api#getmultipleaccounts)
- [getProgramAccounts](https://docs.nexis.network/apps/jsonrpc-api#getprogramaccounts)
- [getRecentBlockhash](https://docs.nexis.network/apps/jsonrpc-api#getrecentblockhash)
- [getRecentPerformanceSamples](https://docs.nexis.network/apps/jsonrpc-api#getrecentperformancesamples)
- [getSnapshotSlot](https://docs.nexis.network/apps/jsonrpc-api#getsnapshotslot)
- [getSignatureStatuses](https://docs.nexis.network/apps/jsonrpc-api#getsignaturestatuses)
- [getSlot](https://docs.nexis.network/apps/jsonrpc-api#getslot)
- [getSlotLeader](https://docs.nexis.network/apps/jsonrpc-api#getslotleader)
- [getSlotLeaders](https://docs.nexis.network/apps/jsonrpc-api#getslotleaders)
- [getStakeActivation](https://docs.nexis.network/apps/jsonrpc-api#getstakeactivation)
- [getSupply](https://docs.nexis.network/apps/jsonrpc-api#getsupply)
- [getTokenAccountBalance](https://docs.nexis.network/apps/jsonrpc-api#gettokenaccountbalance)
- [getTokenAccountsByDelegate](https://docs.nexis.network/apps/jsonrpc-api#gettokenaccountsbydelegate)
- [getTokenAccountsByOwner](https://docs.nexis.network/apps/jsonrpc-api#gettokenaccountsbyowner)
- [getTokenLargestAccounts](https://docs.nexis.network/apps/jsonrpc-api#gettokenlargestaccounts)
- [getTokenSupply](https://docs.nexis.network/apps/jsonrpc-api#gettokensupply)
- [getTransactionCount](https://docs.nexis.network/apps/jsonrpc-api#gettransactioncount)
- [getVersion](https://docs.nexis.network/apps/jsonrpc-api#getversion)
- [getVoteAccounts](https://docs.nexis.network/apps/jsonrpc-api#getvoteaccounts)
- [minimumLedgerSlot](https://docs.nexis.network/apps/jsonrpc-api#minimumledgerslot)
- [requestAirdrop](https://docs.nexis.network/apps/jsonrpc-api#requestairdrop)
- [sendTransaction](https://docs.nexis.network/apps/jsonrpc-api#sendtransaction)
- [simulateTransaction](https://docs.nexis.network/apps/jsonrpc-api#simulatetransaction)
- [Subscription Websocket](https://docs.nexis.network/apps/jsonrpc-api#subscription-websocket)
  - [accountSubscribe](https://docs.nexis.network/apps/jsonrpc-api#accountsubscribe)
  - [accountUnsubscribe](https://docs.nexis.network/apps/jsonrpc-api#accountunsubscribe)
  - [logsSubscribe](https://docs.nexis.network/apps/jsonrpc-api#logssubscribe)
  - [logsUnsubscribe](https://docs.nexis.network/apps/jsonrpc-api#logsunsubscribe)
  - [programSubscribe](https://docs.nexis.network/apps/jsonrpc-api#programsubscribe)
  - [programUnsubscribe](https://docs.nexis.network/apps/jsonrpc-api#programunsubscribe)
  - [signatureSubscribe](https://docs.nexis.network/apps/jsonrpc-api#signaturesubscribe)
  - [signatureUnsubscribe](https://docs.nexis.network/apps/jsonrpc-api#signatureunsubscribe)
  - [slotSubscribe](https://docs.nexis.network/apps/jsonrpc-api#slotsubscribe)
  - [slotUnsubscribe](https://docs.nexis.network/apps/jsonrpc-api#slotunsubscribe)
...
- `<object>` - (optional) Configuration object containing the following optional fields:
  - (optional) [Commitment](https://docs.nexis.network/apps/jsonrpc-api#configuring-state-commitment)
...
- `<string>` - Pubkey of account to query, as base-58 encoded string
- `<object>` - (optional) [Commitment](https://docs.nexis.network/apps/jsonrpc-api#configuring-state-commitment)
...
- `<object>` - if block is confirmed, an object with the following fields:
  ...
  - `transactions: <array>` - an array of JSON objects containing:
    - `transaction: <object|[string,encoding]>` - [Transaction](https://docs.nexis.network/apps/jsonrpc-api#transaction-structure) object, either in JSON format or encoded binary data, depending on encoding parameter
    - `meta: <object>` - transaction status metadata object, containing `null` or:
      - `err: <object | null>` - Error if transaction failed, null if transaction succeeded. [TransactionError definitions](https://github.com/nexis-labs/nexis/blob/master/sdk/src/transaction.rs#L14)
...
Transactions are quite different from those on other blockchains. Be sure to review [Anatomy of a Transaction](https://docs.nexis.network/transaction) to learn about transactions on Nexis Network.
...
- (optional) [Commitment](https://docs.nexis.network/apps/jsonrpc-api#configuring-state-commitment); "processed" is not supported. If parameter not provided, the default is "finalized".
...
- `<object>` - (optional) Configuration object containing the following optional fields:
  ...
  - (optional) `dataSlice: <object>` - limit the returned account data using the provided `offset: <usize>` and `length: <usize>` fields; only available for "base58" or "base64" encoding.
  - (optional) `filters: <array>` - filter results using various [filter objects](https://docs.nexis.network/apps/jsonrpc-api#filters); account must meet all filter criteria to be included in results
...
- `nexis-core`, software version of nexis-core
...
// Result
{"jsonrpc":"2.0","result":{"nexis-core": "1.4.0"},"id":1}
```
...
- `<object>` - (optional) [Commitment](https://docs.nexis.network/apps/jsonrpc-api#configuring-state-commitment) (used for retrieving blockhash and verifying airdrop success)
...
- `<object>` - (optional) Configuration object containing the following field:
  ...
  - `preflightCommitment: <string>` - (optional) [Commitment](https://docs.nexis.network/apps/jsonrpc-api#configuring-state-commitment) level to use for preflight (default: `"max"`).
...
- `<object>` - (optional) Configuration object containing the following field:
  ...
  - `commitment: <string>` - (optional) [Commitment](https://docs.nexis.network/apps/jsonrpc-api#configuring-state-commitment) level to simulate the transaction at (default: `"max"`).
...
- `err: <object | string | null>` - Error if transaction failed, null if transaction succeeded. [TransactionError definitions](https://github.com/nexis-labs/nexis/blob/master/sdk/src/transaction.rs#L14)
...
- Many subscriptions take the optional [commitment parameter](https://docs.nexis.network/apps/jsonrpc-api#configuring-state-commitment), defining how finalized a change should be to trigger a notification. For subscriptions, if commitment is unspecified, the default value is `"single"`.
...
Install the latest Nexis Network release from https://docs.nexis.network/cli/install-nexis-network-cli-tools
...
Example scripts for the Nexis Program Library:

- [Token Program Examples](https://github.com/nexis-labs/nexis-program-library/tree/master/token/js/examples)

## Flow

A [Flow library definition](https://flow.org/en/docs/libdefs/) is provided at https://unpkg.com/@nexis/web3.js@latest/module.flow.js. Download the file and add the following line under the [libs] section of your project’s `.flowconfig` to activate it: {{className: 'break-words'}}

```bash {{ title: 'Example' }}
[libs]

node_modules/@nexis/web3.js/module.flow.js
```
...
All claims, content, designs, algorithms, estimates, roadmaps, specifications, and performance measurements described in this project are done with the Nexis Foundation’s (“SF”) best efforts. It is up to the reader to check and validate their accuracy and truthfulness. Furthermore nothing in this project constitutes a solicitation for investment.

Any content produced by SF or developer resources that SF provides, are for educational and inspiration purposes only. SF does not encourage, induce or sanction the deployment, integration or use of any such applications (including the code comprising the Nexis blockchain protocol) in violation of applicable laws or regulations and hereby prohibits any such deployment, integration or use. This includes use of any such applications by the reader (a) in violation of export control or sanctions laws of the United States or any other applicable jurisdiction, (b) if the reader is located in or ordinarily resident in a country or territory subject to comprehensive sanctions administered by the U.S. Office of Foreign Assets Control (OFAC), or (c) if the reader is or is working on behalf of a Specially Designated National (SDN) or a person subject to similar blocking or denied party prohibitions.

The reader should be aware that U.S. export control and sanctions laws prohibit U.S. persons (and other persons that are subject to such laws) from transacting with persons in certain countries and territories or that are on the SDN list. As a project based primarily on open-source software, it is possible that such sanctioned persons may nevertheless bypass prohibitions, obtain the code comprising the Nexis blockchain protocol (or other project code or applications) and deploy, integrate, or otherwise use it. Accordingly, there is a risk to individuals that other persons using the Nexis blockchain protocol may be sanctioned persons and that transactions with such persons would be a violation of U.S. export controls and sanctions law. This risk applies to individuals, organizations, and other ecosystem participants that deploy, integrate, or use the Nexis blockchain protocol code directly (e.g., as a node operator), and individuals that transact on the Nexis blockchain through light clients, third party interfaces, and/or wallet software.
...
Instructions: LoaderInstruction The BPF Upgradeable Loader marks itself as "owner" of the executable and program-data accounts it creates to store your program. When a user invokes an instruction via a program id, the Nexis Network runtime will load both you’re the program and its owner, the BPF Upgradeable Loader. The runtime then passes your program to the BPF Upgradeable Loader to process the instruction.
...
Nexis Network exposes a variety of cluster state data to programs via sysvar accounts. These accounts are populated at known addresses published along with the account layouts in the `nexis-program` crate, and outlined below.
...
At a minimum, Nexis Network Rust programs must pull in the nexis-program crate.
...
- Crates may depend on `rand` which is not supported in Nexis Network’s deterministic program environment. To include a `rand` dependent crate refer to Depending on Rand.
...
- Install the latest Nexis Network command-line tools from https://docs.nexis.network/cli/install-nexisn-etwork-cli-tools {{className: 'break-words'}}
...
include ~/.local/share/nexis/install/active_release/bin/sdk/bpf/c/bpf.mk
```
...
Install the latest Rust stable from https://rustup.rs Install the latest Nexis Network command-line tools from https://docs.nexis.network/cli/install-nexis-network-cli-tools Then build using make:
...
`export RUST_LOG=nexis_runtime::system_instruction_processor=trace,nexis_runtime::message_processor=info,nexis_bpf_loader=debug,nexis_rbpf=debug` {{className: 'break-words'}}
...
```bash {{ title: '' }}
$ git clone https://github.com/nexis-labs/break.git
$ cd break
```
...
```text {{ title: '' }}
$ git clone https://github.com/nexis-labs/example-webwallet.git
...
https://github.com/nexis-network/nexis-network/blob/v0.3.6/sdk/program/src/program_pack.rs {{className: 'break-words'}}
