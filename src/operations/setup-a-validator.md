...
You can either use
[Nexis Network's Install Tool](../cli/install.md#use-solanas-install-tool) section from
...
[Nexis Network's Install Tool](../cli/install.md#use-solanas-install-tool) or
...
exec nexis-validator \
    ...
    --only-known-rpc \
    --log /home/sol/nexis-validator.log \
    --ledger /mnt/ledger \
    --rpc-port 8899 \
...
```
tail -f /home/sol/nexis-validator*.log
```
