...
- https://native.nexscan.io/ Native explorer.
- https://evm.nexscan.io/ EVM mainnet explorer.
- https://evm-testnet.nexis.network/ EVM testnet explorer.
...
<table className="w-full border-collapse border border-slate-400 bg-white text-sm shadow-sm dark:border-slate-500 dark:bg-inherit">
  ...
  <tbody>
    <tr>
      ...
      <td className="border border-slate-300 px-3 py-0 text-slate-500 dark:border-slate-700 dark:text-slate-200">
        `https://api.testnet.nexis.network`
      </td>
    </tr>
    <tr>
      <td className="border border-slate-300 px-3 py-0 text-slate-500 dark:border-slate-700 dark:text-slate-200">
    ...
    <tr>
      ...
      <td className="border border-slate-300 px-3 py-0 text-slate-500 dark:border-slate-700 dark:text-slate-200">
        `https://native.nexscan.io/?cluster=testnet`
      </td>
    </tr>
    <tr>
      <td className="border border-slate-300 px-3 py-0 text-slate-500 dark:border-slate-700 dark:text-slate-200">
...
- Gossip entrypoint for Testnet: `bootstrap.testnet.nexis.network:8001`
...
<table className="w-full border-collapse border border-slate-400 bg-white text-sm shadow-sm dark:border-slate-500 dark:bg-inherit">
  ...
  <tbody>
    <tr>
      ...
      <td className="border border-slate-300 px-3 py-0 text-slate-500 dark:border-slate-700 dark:text-slate-200">
        `https://api.mainnet.nexis.network`
      </td>
    </tr>
    <tr>
      <td className="border border-slate-300 px-3 py-0 text-slate-500 dark:border-slate-700 dark:text-slate-200">
...
```bash {{ title: '' }}
nexis config set --url https://api.mainnet.nexis.network
```
...
```bash {{ title: '' }}
NDEBUG=1 ./multinode-demo/bench-tps.sh --entrypoint bootstrap-testnet.nexis.network:8001 --faucet api.testnet.nexis.network:9900 --duration 60 --tx_count 50
```
