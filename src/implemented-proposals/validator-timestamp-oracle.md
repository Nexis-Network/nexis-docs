...
Third-party users of Nexis Network sometimes need to know the real-world time a block
...
would allow a Nexis Network cluster to satisfy this need.
...
As of https://github.com/nexis-labs/nexis/pull/10630, validators submit a
